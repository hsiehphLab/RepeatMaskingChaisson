...
rule MergeMaskerRuns:
    ...
    params:
        sd=SD
    shell:"""
module load gcc/7.2.0 && export LD_LIBRARY_PATH=/home/hsiehph/shared/software/packages/htslib:$LD_LIBRARY_PATH && {params.sd}/comask {output.comb} {input.humLib} {input.t2tLib} {input.trfMasked}

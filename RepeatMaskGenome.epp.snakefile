...
then
  ...
  module load gcc/7.2.0 && export LD_LIBRARY_PATH=/home/hsiehph/shared/software/packages/htslib/install/lib:$LD_LIBRARY_PATH && {params.sd}/hardmask {input.mask} $TEMP/to_mask.{wildcards.index}.fasta && \
  pushd $TEMP &&  \

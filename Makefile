...
bemask: MaskBed.cpp
	g++ -O2  $< -o $@  -I /projects/standard/hsiehph/shared/software/packages/htslib/install/include -I $(CONDA_PREFIX)/include -L/projects/standard/hsiehph/shared/software/packages/htslib/install/lib -L$(CONDA_PREFIX)/lib -lhts -Wl,-rpath,$(CONDA_PREFIX)/htslib/lib  -lhts -lz -lpthread
